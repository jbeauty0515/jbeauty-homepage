    ...
    <HeaderWrapper
      ...
      animate={{
        ...
        boxShadow: isScrolled
          ...
          : "0 0 0 rgba(0, 0, 0, 0)",
        paddingTop: isScrolled ? "10px" : "13px",
        paddingBottom: isScrolled ? "10px" : "13px",
      }}
      ...
      <HeaderInner>
        <Logo>
          <Link href="/" aria-label="Go to home">
            <LogoImg src={logoSrc} alt="j-beauty" $isWhite={isWhiteLogo} />
          </Link>
        </Logo>
...
const Hamburger = styled.button<{ $open: boolean; $isWhite: boolean }>`
  ...
  @media (max-width: 768px) {
    ...
    span {
      ...
      width: 28px;
      height: 2px;
      background: ${({ $isWhite, $open }) =>
        $open ? "#333" : $isWhite ? "#fff" : "#333"};
